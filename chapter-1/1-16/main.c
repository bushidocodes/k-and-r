 ...
 * K&R Exercise 1-16
 * Page 30
 * Revise the main routine of the longest line progrma so it will correctly print the lenght of
 * arbirarily long input lines, and as much as possible of the text
 * Completed
 **/
